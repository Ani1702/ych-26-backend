/*
  ...
  - The values [UNDER_EVALUATION] on the enum `QualificationStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "QualificationStatus_new" AS ENUM ('NOT_SUBMITTED', 'SUBMITTED', 'QUALIFIED', 'NOT_QUALIFIED');
